...
struct ChatPerformanceFixture: Sendable {
    ...
    static func appendingStreamStep(
        ...
        items[lastIndex] = CodexThreadItem(
            ...
            collaborationInitiatorSessionId: previous.collaborationInitiatorSessionId,
            collaborationInitiatorSessionTitle: previous.collaborationInitiatorSessionTitle,
            collaborationInitiatorSessionKind: previous.collaborationInitiatorSessionKind,
            collaborationRecipientSessionId: previous.collaborationRecipientSessionId,
            collaborationRecipientSessionTitle: previous.collaborationRecipientSessionTitle,
            collaborationRecipientSessionKind: previous.collaborationRecipientSessionKind,
            collaborationSourceObjectiveId: previous.collaborationSourceObjectiveId,
            collaborationSourceObjectiveName: previous.collaborationSourceObjectiveName,
            collaborationTargetObjectiveId: previous.collaborationTargetObjectiveId,
            collaborationTargetObjectiveName: previous.collaborationTargetObjectiveName,
            collaborationSourceCorptieTaskId: previous.collaborationSourceCorptieTaskId,
            collaborationTargetCorptieTaskId: previous.collaborationTargetCorptieTaskId,
            collaborationRelation: previous.collaborationRelation,
            collaborationRouteStatus: previous.collaborationRouteStatus,
            collaborationRoutingVersion: previous.collaborationRoutingVersion,
