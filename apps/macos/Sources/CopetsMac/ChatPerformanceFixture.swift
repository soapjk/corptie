...
struct ChatPerformanceFixture: Sendable {
    ...
    static func appendingStreamStep(
        ...
        items[lastIndex] = CodexThreadItem(
            ...
            collaborationSourceWorkId: previous.collaborationSourceWorkId,
            collaborationSourceWorkName: previous.collaborationSourceWorkName,
            collaborationTargetWorkId: previous.collaborationTargetWorkId,
            collaborationTargetWorkName: previous.collaborationTargetWorkName,
