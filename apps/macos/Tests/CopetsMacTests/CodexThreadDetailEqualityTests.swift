...
struct CodexThreadDetailEqualityTests {
    ...
    private func replacingText(in item: CodexThreadItem, with text: String) -> CodexThreadItem {
        CodexThreadItem(
            ...
            workItemId: item.workItemId, collaborationTaskId: item.collaborationTaskId,
            ...
            collaborationSourceObjectiveId: item.collaborationSourceObjectiveId,
            collaborationSourceObjectiveName: item.collaborationSourceObjectiveName,
            collaborationTargetObjectiveId: item.collaborationTargetObjectiveId,
            collaborationTargetObjectiveName: item.collaborationTargetObjectiveName,
            collaborationSourceWorkItemId: item.collaborationSourceWorkItemId,
            collaborationTargetWorkItemId: item.collaborationTargetWorkItemId,
