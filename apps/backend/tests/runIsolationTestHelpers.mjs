...
export const session = Object.freeze({logicalSessionId:"logical:test",workItemId:"work_item:test",repositoryId:null,worktreeId:null});
...
export function toolsetFixture({receiptId="toolset_validation_receipt:shared",sourceFingerprint="d".repeat(64),authority={logicalSessionId:"logical:test",workItemId:"work_item:test",repositoryId:"repository:a",worktreeId:"worktree:a"}}={}) {
