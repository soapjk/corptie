    ...
    async getSnapshot() {
      return {
        ...
        items: [{
          ...
          collaborationSourceWorkId: "work:peer",
          collaborationSourceWorkName: "Peer Work",
          collaborationTargetWorkId: "work:current",
          collaborationTargetWorkName: "Current Work",
