...
export class BenchmarkControlPlane {
  ...
  #scope(logicalSessionId) {
    ...
    if (!binding.workId || !binding.taskId) throw benchmarkError("BENCHMARK_WORK_SESSION_REQUIRED", "Benchmark writes require a bound Worker Session.", "authorization", { statusCode: 403 });
    return { logicalSessionId: binding.logicalSessionId, workId: binding.workId, taskId: binding.taskId };
  }
}
