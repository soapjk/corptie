...
export const DEPENDENCY_CONTRACT_MANIFEST = Object.freeze({
  ...
  entries: Object.freeze([
    ...
    fixed("search", "schema", "artifact:ee9b734f-799d-41b6-804f-9868697de511", "920fa9b2952490e4e4c93c88ca2855c11aeac9ff615bea43f738feff7d6d93e9", { CleanupReceipt: 4, RepositorySourceSnapshotReceipt: 1, RunReceipt: 6, SearchReceipt: 1, StartupBindingReceipt: 2, ToolsetValidationReceipt: 3 }),
    ...
    fixed("toolset", "schema", "artifact:ed9a09d9-d2b1-4446-9a34-4ef491570ef3", "11211c8f21c166f50e38f07b99650e000e32f703f5417a613ffe8775e1a4a54d", { ToolsetValidationReceipt: 3 })
...
const profiles = {
  ...
  StartupBindingReceipt: {
    ...
    fields: ["schemaVersion", "status", "startupOperationId", "objectiveId", "workItemId", "logicalSessionId", "repositoryId", "worktreeId", "canonicalWorktreePath", "headIdentity", "providerBindingId", "bindingGeneration", "sourceCommitOid", "sourceTreeOid", "baseRef", "repositoryInventoryVersion", "workspaceResourceVersion", "resourceVersion", "providerContextHash", "phaseTimestamps", "compensation", "error", "receiptHash"],
    required: ["objectiveId", "workItemId", "logicalSessionId", "providerBindingId", "bindingGeneration", "repositoryId", "worktreeId", "startupOperationId", "receiptHash"], forbidden: ["catalogVersion", "toolsetVersion", "sourceFingerprint", "runId", "observationId"]
  },
  RepositorySourceSnapshotReceipt: {
    stage: "snapshot", producer: "repository-source-snapshot", schemaVersion: 1,
    fields: ["receiptId", "schemaVersion", "resourceVersion", "artifactRef", "startupBindingRef", "objectiveId", "workItemId", "logicalSessionId", "repositoryId", "worktreeId", "sourceCommitOid", "sourceTreeOid", "dirtyOverlayRef", "ignoreConfigRevisionRef", "scopeRootHash", "sourceFingerprint", "createdAt", "receiptHash"],
    required: ["objectiveId", "workItemId", "logicalSessionId", "repositoryId", "worktreeId", "receiptId", "sourceFingerprint", "receiptHash"], forbidden: ["catalogVersion", "toolsetVersion", "runId", "observationId", "queryHash", "indexVersion", "resultSummary"]
  },
  ...
  RunReceipt: {
    ...
    required: ["logicalSessionId", "workItemId", "runId", "receiptId", "receiptHash", "sourceFingerprint", "startupBindingReceiptRef", "repositorySourceSnapshotReceiptRef"], forbidden: ["objectiveId", "catalogVersion", "observationId"]
  },
  CleanupReceipt: {
    stage: "cleanup", producer: "run-isolation", schemaVersion: 4,
    fields: ["schemaVersion", "receiptId", "receiptHash", "cleanupOperationId", "runId", "runReceiptRef", "logicalSessionId", "workItemId", "repositoryId", "worktreeId", "sourceFingerprint", "outcome", "policy", "ownerSessionId", "retentionReason", "retentionPolicyVersion", "retainUntil", "quotaBytes", "observedBytes", "fencingToken", "resourceVersion", "dataRootBindingId", "sourceIdentityHash", "trashIdentityHash", "safetyChecks", "processReconciliation", "bytesReclaimed", "filesRemoved", "eventRefs", "startedAt", "finishedAt", "error"],
    required: ["runId", "runReceiptRef", "logicalSessionId", "workItemId", "receiptId", "receiptHash", "outcome", "safetyChecks"], forbidden: ["catalogVersion", "toolsetVersion", "observationId"]
  },
  SearchReceipt: {
...
export function receiptIdentitySubset(type, value) {
  switch (type) {
    ...
    case "StartupBindingReceipt": return pick(value, ["objectiveId", "workItemId", "logicalSessionId", "providerBindingId", "bindingGeneration", "repositoryId", "worktreeId", "startupOperationId", "receiptHash"]);
    case "RepositorySourceSnapshotReceipt": return pick(value, ["objectiveId", "workItemId", "logicalSessionId", "repositoryId", "worktreeId", "receiptId", "sourceFingerprint", "receiptHash"]);
    case "ToolsetValidationReceipt": return { ...pick(value.identity, ["logicalSessionId", "objectiveId", "workItemId", "repositoryId", "worktreeId"]), snapshotReceiptId: value.snapshotRef?.receiptId, sourceFingerprint: value.snapshotRef?.sourceFingerprint, ...pick(value, ["toolsetVersion", "validationPlanIdentity", "receiptId", "receiptHash"]) };
    case "RunReceipt": return pick(value, ["logicalSessionId", "workItemId", "repositoryId", "worktreeId", "runId", "receiptId", "receiptHash", "sourceFingerprint"]);
    case "CleanupReceipt": return pick(value, ["runId", "logicalSessionId", "workItemId", "repositoryId", "worktreeId", "sourceFingerprint", "receiptId", "receiptHash", "outcome"]);
    ...
    case "Observation": return { observationId: value.observationId, ...pick(value.identity, ["objectiveId", "workItemId", "logicalSessionId", "providerBindingId", "bindingGeneration", "repositoryId", "worktreeId"]), runId: value.runId };
    case "ObservationExport": return { ...pick(value.identity, ["objectiveId", "workItemId", "logicalSessionId", "providerBindingId", "bindingGeneration", "repositoryId", "worktreeId"]), ...pick(value.versions, ["catalogVersion", "toolsetVersion", "sourceFingerprint"]), summaryHash: value.summaryHash };
...
function validateSemantics(type, value, options) {
  ...
  if (type === "Observation") {
    closedNested(value.identity, ["objectiveId", "workItemId", "logicalSessionId", "providerBindingId", "bindingGeneration", "repositoryId", "worktreeId", "turnId"], "Observation identity");
