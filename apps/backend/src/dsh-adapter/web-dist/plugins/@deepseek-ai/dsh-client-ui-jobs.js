window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".kY16Ma_root{position:relative}.kY16Ma_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.kY16Ma_trigger:hover,.kY16Ma_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.kY16Ma_trigger svg{transition:transform .12s}.kY16Ma_triggerOpen{transform:rotate(180deg)}.kY16Ma_triggerDot{flex:none}.kY16Ma_count{margin:0 5px}.kY16Ma_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.kY16Ma_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.kY16Ma_rowSettled{color:var(--dsw-alias-label-tertiary)}.kY16Ma_rowDot{flex:none}.kY16Ma_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.kY16Ma_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.kY16Ma_status,.kY16Ma_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.kY16Ma_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.kY16Ma_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"status": "kY16Ma_status",
			"rowSettled": "kY16Ma_rowSettled",
			"count": "kY16Ma_count",
			"trigger": "kY16Ma_trigger",
			"triggerOpen": "kY16Ma_triggerOpen",
			"kind": "kY16Ma_kind",
			"duration": "kY16Ma_duration",
			"root": "kY16Ma_root",
			"menu": "kY16Ma_menu",
			"rowDot": "kY16Ma_rowDot",
			"label": "kY16Ma_label",
			"row": "kY16Ma_row",
			"triggerDot": "kY16Ma_triggerDot"
		};
		//#endregion
