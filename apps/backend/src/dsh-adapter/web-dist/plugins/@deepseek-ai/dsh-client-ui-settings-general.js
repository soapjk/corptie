window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = ".qEU0LW_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.qEU0LW_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.qEU0LW_trigger.qEU0LW_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.qEU0LW_triggerLabel{white-space:nowrap;overflow:hidden}.qEU0LW_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.qEU0LW_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.qEU0LW_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}.qEU0LW_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.qEU0LW_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.qEU0LW_navList{flex-direction:column;gap:4px;display:flex}.qEU0LW_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.qEU0LW_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.qEU0LW_navCell.qEU0LW_active{background:var(--dsw-specific-sidebar-nav-item-active)}.qEU0LW_navIcon{flex:none}.qEU0LW_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.qEU0LW_content{flex-direction:column;flex:1;min-width:0;display:flex}.qEU0LW_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.qEU0LW_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.qEU0LW_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.qEU0LW_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.qEU0LW_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.qEU0LW_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"active": "qEU0LW_active",
			"close": "qEU0LW_close",
			"triggerLabel": "qEU0LW_triggerLabel",
			"rail": "qEU0LW_rail",
			"navTitle": "qEU0LW_navTitle",
			"content": "qEU0LW_content",
			"hiddenLabel": "qEU0LW_hiddenLabel",
			"navIcon": "qEU0LW_navIcon",
			"panel": "qEU0LW_panel",
			"nav": "qEU0LW_nav",
			"navCell": "qEU0LW_navCell",
			"options": "qEU0LW_options",
			"trigger": "qEU0LW_trigger",
			"navList": "qEU0LW_navList",
			"overlay": "qEU0LW_overlay",
			"navLabel": "qEU0LW_navLabel",
			"header": "qEU0LW_header",
			"mask": "qEU0LW_mask",
			"actions": "qEU0LW_actions"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = ".W8sj-W_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "W8sj-W_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".EOCduq_section{flex-direction:column;width:100%;display:flex}.EOCduq_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "EOCduq_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".KyqQSa_action{align-items:center;gap:8px;min-width:0;display:flex}.KyqQSa_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
