window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".Ni4baa_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.Ni4baa_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.Ni4baa_card,.Ni4baa_card *{box-sizing:border-box}.Ni4baa_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.Ni4baa_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.Ni4baa_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.Ni4baa_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.Ni4baa_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.Ni4baa_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.Ni4baa_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.Ni4baa_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.Ni4baa_card{border-radius:16px}.Ni4baa_body{padding:10px 12px 4px}.Ni4baa_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "Ni4baa_actions",
			"body": "Ni4baa_body",
			"card": "Ni4baa_card",
			"dot": "Ni4baa_dot",
			"footer": "Ni4baa_footer",
			"discuss": "Ni4baa_discuss",
			"strip": "Ni4baa_strip",
			"frame": "Ni4baa_frame",
			"feedback": "Ni4baa_feedback"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".hGepzG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.hGepzG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.hGepzG_card,.hGepzG_card *{box-sizing:border-box}.hGepzG_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.hGepzG_headingBlock{min-width:0}.hGepzG_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.hGepzG_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.hGepzG_detail{margin:0 2px 8px}.hGepzG_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.hGepzG_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.hGepzG_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.hGepzG_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.hGepzG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.hGepzG_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.hGepzG_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.hGepzG_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.hGepzG_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.hGepzG_option:hover:not(:disabled),.hGepzG_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.hGepzG_optionSelected{border-color:var(--dsw-alias-border-l2)}.hGepzG_option:disabled{cursor:default}.hGepzG_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.hGepzG_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.hGepzG_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.hGepzG_checkbox>svg{grid-area:1/1}.hGepzG_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.hGepzG_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.hGepzG_optionCopy{flex:1;min-width:0}.hGepzG_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.hGepzG_optionLabel{font-size:14px;font-weight:500;line-height:24px}.hGepzG_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.hGepzG_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.hGepzG_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.hGepzG_customRow:hover,.hGepzG_customRow:focus-within,.hGepzG_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.hGepzG_customRow:focus-within,.hGepzG_customRowActive{border-color:var(--dsw-alias-border-l2)}.hGepzG_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.hGepzG_customInput::placeholder{color:var(--dsw-alias-label-caption)}.hGepzG_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.hGepzG_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.hGepzG_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.hGepzG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.hGepzG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.hGepzG_card{border-radius:16px}.hGepzG_header{padding:10px 12px 0 18px}.hGepzG_options{padding:4px 8px}.hGepzG_title{font-size:15px;line-height:21px}.hGepzG_option,.hGepzG_customRow{padding:8px 6px}.hGepzG_footer{align-items:flex-end;padding:0 10px}.hGepzG_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.hGepzG_option,.hGepzG_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"eyebrow": "hGepzG_eyebrow",
			"customRow": "hGepzG_customRow",
			"number": "hGepzG_number",
			"footerActions": "hGepzG_footerActions",
			"optionLine": "hGepzG_optionLine",
			"footer": "hGepzG_footer",
			"optionLabel": "hGepzG_optionLabel",
			"pager": "hGepzG_pager",
			"checkboxChecked": "hGepzG_checkboxChecked",
			"badge": "hGepzG_badge",
			"header": "hGepzG_header",
			"feedback": "hGepzG_feedback",
			"customTextarea": "hGepzG_customTextarea",
			"description": "hGepzG_description",
			"optionSelected": "hGepzG_optionSelected",
			"card": "hGepzG_card",
			"body": "hGepzG_body",
			"headingBlock": "hGepzG_headingBlock",
			"frame": "hGepzG_frame",
			"detail": "hGepzG_detail",
			"options": "hGepzG_options",
			"iconButton": "hGepzG_iconButton",
			"optionCopy": "hGepzG_optionCopy",
			"title": "hGepzG_title",
			"checkbox": "hGepzG_checkbox",
			"customRowActive": "hGepzG_customRowActive",
			"customInput": "hGepzG_customInput",
			"progress": "hGepzG_progress",
			"option": "hGepzG_option"
		};
		//#endregion
