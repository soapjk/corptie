window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".jqsgNa_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.jqsgNa_field+.jqsgNa_field{border-top:1px solid var(--dsw-alias-border-l2)}.jqsgNa_head{align-items:center;gap:8px;display:flex}.jqsgNa_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.jqsgNa_badges{align-items:center;gap:8px;display:inline-flex}.jqsgNa_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.jqsgNa_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.jqsgNa_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.jqsgNa_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.jqsgNa_reset:disabled{cursor:default}.jqsgNa_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.jqsgNa_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.jqsgNa_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.jqsgNa_inputInvalid{border-color:var(--dsw-alias-label-error);}.jqsgNa_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.jqsgNa_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"inputInvalid": "jqsgNa_inputInvalid",
			"badgeMuted": "jqsgNa_badgeMuted",
			"hint": "jqsgNa_hint",
			"reset": "jqsgNa_reset",
			"input": "jqsgNa_input",
			"badges": "jqsgNa_badges",
			"head": "jqsgNa_head",
			"label": "jqsgNa_label",
			"invalid": "jqsgNa_invalid",
			"field": "jqsgNa_field",
			"badge": "jqsgNa_badge"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".ApjDLW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.ApjDLW_card:hover{border-color:var(--dsw-alias-label-dimmed)}.ApjDLW_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.ApjDLW_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.ApjDLW_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.ApjDLW_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.ApjDLW_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.ApjDLW_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.ApjDLW_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.ApjDLW_chevronOpen{transform:rotate(180deg)}.ApjDLW_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.ApjDLW_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.ApjDLW_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.ApjDLW_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.ApjDLW_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.ApjDLW_discard,.ApjDLW_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.ApjDLW_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.ApjDLW_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.ApjDLW_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.ApjDLW_discard:disabled,.ApjDLW_save:disabled{opacity:.4;cursor:default}.ApjDLW_discard:focus-visible,.ApjDLW_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"header": "ApjDLW_header",
			"footer": "ApjDLW_footer",
			"card": "ApjDLW_card",
			"description": "ApjDLW_description",
			"failed": "ApjDLW_failed",
			"pending": "ApjDLW_pending",
			"save": "ApjDLW_save",
			"cardOpen": "ApjDLW_cardOpen",
			"chevronOpen": "ApjDLW_chevronOpen",
			"headText": "ApjDLW_headText",
			"name": "ApjDLW_name",
			"chevron": "ApjDLW_chevron",
			"body": "ApjDLW_body",
			"readOnly": "ApjDLW_readOnly",
			"discard": "ApjDLW_discard"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".xGo-6G_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.xGo-6G_heading{margin:0;font-size:18px;font-weight:600}.xGo-6G_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.xGo-6G_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.xGo-6G_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.xGo-6G_tab:hover,.xGo-6G_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.xGo-6G_tab[data-active=true]:after,.xGo-6G_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.xGo-6G_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.xGo-6G_panel{min-width:0;padding-top:2px}.xGo-6G_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.xGo-6G_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"intro": "xGo-6G_intro",
			"tab": "xGo-6G_tab",
			"section": "xGo-6G_section",
			"panel": "xGo-6G_panel",
			"tabs": "xGo-6G_tabs",
			"cards": "xGo-6G_cards",
			"empty": "xGo-6G_empty",
			"heading": "xGo-6G_heading"
		};
		//#endregion
