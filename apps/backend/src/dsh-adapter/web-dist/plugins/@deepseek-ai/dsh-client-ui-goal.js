window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-goal/src/client/GoalCommandInputView.module.css.mjs
		const css = ".Nzmf6a_row{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.Nzmf6a_stack{flex-direction:column;align-items:flex-end;min-width:0;max-width:min(525px,82%);display:flex}.Nzmf6a_bubble{overflow-wrap:anywhere;background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code);white-space:pre-wrap;border-radius:22px;padding:10px 16px}";
