window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = ".Gaf7Va_root{position:relative}.Gaf7Va_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.Gaf7Va_count{margin:0 5px}.Gaf7Va_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.Gaf7Va_trigger:hover,.Gaf7Va_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.Gaf7Va_trigger svg{transition:transform .12s}.Gaf7Va_triggerOpen{transform:rotate(180deg)}.Gaf7Va_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.Gaf7Va_node{min-width:0;position:relative}.Gaf7Va_menu>.Gaf7Va_node{margin-left:-3px}.Gaf7Va_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.Gaf7Va_row:hover>.Gaf7Va_clickarea,.Gaf7Va_row:focus-visible>.Gaf7Va_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.Gaf7Va_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.Gaf7Va_row>[data-state],.Gaf7Va_clickarea>[data-state]{margin-top:4px}.Gaf7Va_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.Gaf7Va_disabled:hover{background:0 0}.Gaf7Va_loadingRow{cursor:default}.Gaf7Va_disclosure,.Gaf7Va_disclosureSpace{flex:none;width:14px;height:18px}.Gaf7Va_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.Gaf7Va_disclosure:hover{color:var(--dsw-alias-label-primary)}.Gaf7Va_disclosureOpen{transform:rotate(90deg)}.Gaf7Va_content{flex-direction:column;flex:1;min-width:0;display:flex}.Gaf7Va_label,.Gaf7Va_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Gaf7Va_label{color:inherit;font-weight:400}.Gaf7Va_summary,.Gaf7Va_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.Gaf7Va_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.Gaf7Va_metricToken{grid-row:1;line-height:18px}.Gaf7Va_metricDuration{grid-row:2}.Gaf7Va_children{margin-left:18px;padding-left:4px;position:relative}.Gaf7Va_children:before,.Gaf7Va_children>.Gaf7Va_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.Gaf7Va_children:before{height:26px;top:-26px}.Gaf7Va_children[aria-busy=true]:before{content:none}.Gaf7Va_children>.Gaf7Va_node:before{top:0;bottom:0;left:-4px}.Gaf7Va_children>.Gaf7Va_node:last-child:before{height:17px;bottom:auto}.Gaf7Va_children>.Gaf7Va_node>.Gaf7Va_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.Gaf7Va_notice,.Gaf7Va_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.Gaf7Va_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.Gaf7Va_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.Gaf7Va_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"loadingRow": "Gaf7Va_loadingRow",
			"disclosure": "Gaf7Va_disclosure",
			"disclosureOpen": "Gaf7Va_disclosureOpen",
			"disclosureSpace": "Gaf7Va_disclosureSpace",
			"count": "Gaf7Va_count",
			"summary": "Gaf7Va_summary",
			"root": "Gaf7Va_root",
			"error": "Gaf7Va_error",
			"metricToken": "Gaf7Va_metricToken",
			"disabled": "Gaf7Va_disabled",
			"trigger": "Gaf7Va_trigger",
			"clickarea": "Gaf7Va_clickarea",
			"triggerOpen": "Gaf7Va_triggerOpen",
			"label": "Gaf7Va_label",
			"menu": "Gaf7Va_menu",
			"children": "Gaf7Va_children",
			"notice": "Gaf7Va_notice",
			"metrics": "Gaf7Va_metrics",
			"refresh": "Gaf7Va_refresh",
			"row": "Gaf7Va_row",
			"activitySlot": "Gaf7Va_activitySlot",
			"content": "Gaf7Va_content",
			"node": "Gaf7Va_node",
			"metricDuration": "Gaf7Va_metricDuration"
		};
		//#endregion
		...
		*/
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "V3EpDq_frame" };
		//#endregion
