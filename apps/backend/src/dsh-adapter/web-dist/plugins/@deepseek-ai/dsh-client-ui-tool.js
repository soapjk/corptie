window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".EzRbQq_root{flex-direction:column;display:flex}.EzRbQq_row{position:relative;overflow:hidden}.EzRbQq_root[data-state=running] .EzRbQq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite EzRbQq_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes EzRbQq_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.EzRbQq_leading{flex-shrink:0}.EzRbQq_root[data-tool^=cordis_] .EzRbQq_leading,.EzRbQq_root[data-tool^=cordis_] .EzRbQq_title{color:var(--dsw-alias-state-business-primary)}.EzRbQq_root[data-tool^=cordis_] .EzRbQq_title{font-weight:500}.EzRbQq_root[data-tool^=cordis_] .EzRbQq_sep{background:var(--dsw-alias-state-business-primary)}.EzRbQq_chevron{color:var(--dsw-alias-label-secondary)}.EzRbQq_title{font-weight:400}.EzRbQq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.EzRbQq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.EzRbQq_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.EzRbQq_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.EzRbQq_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.EzRbQq_errorSummary{color:var(--dsw-alias-state-error-primary)}.EzRbQq_bodyWrap{flex-direction:column;display:flex}.EzRbQq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.EzRbQq_root:hover .EzRbQq_inspectButton,.EzRbQq_inspectButton:focus-visible{opacity:1}.EzRbQq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.EzRbQq_bodyScroll{max-height:260px;overflow-y:auto}.EzRbQq_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.EzRbQq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.EzRbQq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.EzRbQq_ioSection::-webkit-scrollbar-track{margin:6px 0}.EzRbQq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.EzRbQq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.EzRbQq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.EzRbQq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.EzRbQq_codeBody,.EzRbQq_terminalBody,.EzRbQq_diffBody,.EzRbQq_readBody,.EzRbQq_searchBody,.EzRbQq_webBody{margin:4px 0 4px 4px}.EzRbQq_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.EzRbQq_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.EzRbQq_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.EzRbQq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"title": "EzRbQq_title",
			"bodyScroll": "EzRbQq_bodyScroll",
			"sep": "EzRbQq_sep",
			"ioSection": "EzRbQq_ioSection",
			"codeBody": "EzRbQq_codeBody",
			"searchRecovery": "EzRbQq_searchRecovery",
			"visuallyHidden": "EzRbQq_visuallyHidden",
			"summarySuffix": "EzRbQq_summarySuffix",
			"root": "EzRbQq_root",
			"errorSummary": "EzRbQq_errorSummary",
			"ioCard": "EzRbQq_ioCard",
			"leading": "EzRbQq_leading",
			"ioLabel": "EzRbQq_ioLabel",
			"inspectButton": "EzRbQq_inspectButton",
			"ioDivider": "EzRbQq_ioDivider",
			"ioText": "EzRbQq_ioText",
			"row": "EzRbQq_row",
			"bodyWrap": "EzRbQq_bodyWrap",
			"chevron": "EzRbQq_chevron",
			"summary": "EzRbQq_summary",
			"webBody": "EzRbQq_webBody",
			"diffBody": "EzRbQq_diffBody",
			"fileLink": "EzRbQq_fileLink",
			"dsh-tool-row-sweep": "EzRbQq_dsh-tool-row-sweep",
			"terminalBody": "EzRbQq_terminalBody",
			"readBody": "EzRbQq_readBody",
			"searchBody": "EzRbQq_searchBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".tM86jW_callRow{border-radius:6px}.tM86jW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "tM86jW_callRow",
			"subCalls": "tM86jW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".XwE5oa_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.XwE5oa_cardBody{margin:0}.XwE5oa_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.XwE5oa_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.XwE5oa_code[data-error]{color:var(--dsw-alias-state-error-primary)}.XwE5oa_read,.XwE5oa_web{margin:0}.XwE5oa_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"web": "XwE5oa_web",
			"empty": "XwE5oa_empty",
			"recovery": "XwE5oa_recovery",
			"read": "XwE5oa_read",
			"description": "XwE5oa_description",
			"cardBody": "XwE5oa_cardBody",
			"code": "XwE5oa_code"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".hr93_W_card{flex-direction:column;display:flex}.hr93_W_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.hr93_W_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.hr93_W_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.hr93_W_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.hr93_W_ioSection::-webkit-scrollbar-track{margin:6px 0}.hr93_W_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.hr93_W_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.hr93_W_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.hr93_W_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.hr93_W_root[data-expandable]{cursor:pointer}.hr93_W_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.hr93_W_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite hr93_W_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes hr93_W_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.hr93_W_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.hr93_W_chevron{color:var(--dsw-alias-label-secondary)}.hr93_W_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.hr93_W_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.hr93_W_root:hover .hr93_W_iconIdle{opacity:0}.hr93_W_root:hover .hr93_W_chevronHover{opacity:1}.hr93_W_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.hr93_W_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.hr93_W_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.hr93_W_errorSummary{color:var(--dsw-alias-state-error-primary)}.hr93_W_bodyWrap{flex-direction:column;display:flex}.hr93_W_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.hr93_W_card:hover .hr93_W_inspectButton,.hr93_W_inspectButton:focus-visible{opacity:1}.hr93_W_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.hr93_W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"iconIdle": "hr93_W_iconIdle",
			"ioSection": "hr93_W_ioSection",
			"dsh-bash-row-sweep": "hr93_W_dsh-bash-row-sweep",
			"sep": "hr93_W_sep",
			"bodyWrap": "hr93_W_bodyWrap",
			"chevronHover": "hr93_W_chevronHover",
			"terminal": "hr93_W_terminal",
			"card": "hr93_W_card",
			"ioText": "hr93_W_ioText",
			"root": "hr93_W_root",
			"leading": "hr93_W_leading",
			"ioCard": "hr93_W_ioCard",
			"ioLabel": "hr93_W_ioLabel",
			"chevron": "hr93_W_chevron",
			"summary": "hr93_W_summary",
			"errorSummary": "hr93_W_errorSummary",
			"inspectButton": "hr93_W_inspectButton",
			"visuallyHidden": "hr93_W_visuallyHidden",
			"title": "hr93_W_title",
			"ioDivider": "hr93_W_ioDivider"
		};
		//#endregion
