window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".J7q3eG_root{min-width:0;position:relative}.J7q3eG_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.J7q3eG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.J7q3eG_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.J7q3eG_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.J7q3eG_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.J7q3eG_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.J7q3eG_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.J7q3eG_chevronOpen{transform:rotate(180deg)}.J7q3eG_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.J7q3eG_status,.J7q3eG_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.J7q3eG_error,.J7q3eG_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.J7q3eG_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.J7q3eG_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.J7q3eG_groups{min-height:0;overflow-y:auto}.J7q3eG_group+.J7q3eG_group{margin-top:4px}.J7q3eG_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.J7q3eG_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.J7q3eG_option:hover:not(:disabled),.J7q3eG_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.J7q3eG_selected{background:0 0}.J7q3eG_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.J7q3eG_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.J7q3eG_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.J7q3eG_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.J7q3eG_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.J7q3eG_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.J7q3eG_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.J7q3eG_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.J7q3eG_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.J7q3eG_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"modelName": "J7q3eG_modelName",
			"check": "J7q3eG_check",
			"error": "J7q3eG_error",
			"retry": "J7q3eG_retry",
			"triggerEffort": "J7q3eG_triggerEffort",
			"group": "J7q3eG_group",
			"selected": "J7q3eG_selected",
			"cell": "J7q3eG_cell",
			"cellLabel": "J7q3eG_cellLabel",
			"root": "J7q3eG_root",
			"trigger": "J7q3eG_trigger",
			"groupTitle": "J7q3eG_groupTitle",
			"cellValue": "J7q3eG_cellValue",
			"empty": "J7q3eG_empty",
			"cellChevron": "J7q3eG_cellChevron",
			"chevron": "J7q3eG_chevron",
			"menu": "J7q3eG_menu",
			"optionCopy": "J7q3eG_optionCopy",
			"description": "J7q3eG_description",
			"status": "J7q3eG_status",
			"option": "J7q3eG_option",
			"warning": "J7q3eG_warning",
			"chevronOpen": "J7q3eG_chevronOpen",
			"triggerLabel": "J7q3eG_triggerLabel",
			"groups": "J7q3eG_groups"
		};
		//#endregion
