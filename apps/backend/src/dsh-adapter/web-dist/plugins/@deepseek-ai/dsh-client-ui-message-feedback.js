window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-message-feedback/src/client/MessageFeedbackActions.module.css.mjs
		const css = ".gCTVjG_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.gCTVjG_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.gCTVjG_action:disabled{cursor:default;opacity:.4}.gCTVjG_action[data-active]{color:var(--dsw-alias-label-primary)}.gCTVjG_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;font-size:13px;line-height:28px;overflow:hidden}.gCTVjG_noteOpen:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.gCTVjG_noteEditor{align-items:flex-start;gap:6px;display:inline-flex}.gCTVjG_noteInput{border:1px solid var(--dsw-alias-border-secondary);background:var(--dsw-alias-bg-primary);width:260px;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.gCTVjG_noteSave,.gCTVjG_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.gCTVjG_noteSave{background:var(--dsw-alias-interactive-bg-primary);color:var(--dsw-alias-label-inverse)}.gCTVjG_noteSave:disabled{cursor:default;opacity:.4}.gCTVjG_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.gCTVjG_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.gCTVjG_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:28px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"failure": "gCTVjG_failure",
			"noteOpen": "gCTVjG_noteOpen",
			"action": "gCTVjG_action",
			"noteSave": "gCTVjG_noteSave",
			"noteEditor": "gCTVjG_noteEditor",
			"noteCancel": "gCTVjG_noteCancel",
			"noteInput": "gCTVjG_noteInput"
		};
		//#endregion
