window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".lkl1Dq_card{flex-direction:column;display:flex}.lkl1Dq_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.lkl1Dq_row[data-expandable]{cursor:pointer}.lkl1Dq_card[data-state=running] .lkl1Dq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite lkl1Dq_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes lkl1Dq_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.lkl1Dq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.lkl1Dq_chevron{color:var(--dsw-alias-label-secondary)}.lkl1Dq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.lkl1Dq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.lkl1Dq_row:hover .lkl1Dq_iconIdle{opacity:0}.lkl1Dq_row:hover .lkl1Dq_chevronHover{opacity:1}.lkl1Dq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.lkl1Dq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.lkl1Dq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.lkl1Dq_errorSummary{color:var(--dsw-alias-state-error-primary)}.lkl1Dq_bodyWrap{flex-direction:column;display:flex}.lkl1Dq_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.lkl1Dq_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.lkl1Dq_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.lkl1Dq_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.lkl1Dq_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.lkl1Dq_instructions::-webkit-scrollbar-track{margin:6px 0}.lkl1Dq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.lkl1Dq_card:hover .lkl1Dq_inspectButton,.lkl1Dq_inspectButton:focus-visible{opacity:1}.lkl1Dq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.lkl1Dq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.lkl1Dq_card[data-state=running] .lkl1Dq_row:after{animation:none;display:none}.lkl1Dq_iconIdle,.lkl1Dq_chevronHover,.lkl1Dq_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"instructionsHeader": "lkl1Dq_instructionsHeader",
			"inspectButton": "lkl1Dq_inspectButton",
			"card": "lkl1Dq_card",
			"chevronHover": "lkl1Dq_chevronHover",
			"bodyWrap": "lkl1Dq_bodyWrap",
			"instructionsCard": "lkl1Dq_instructionsCard",
			"title": "lkl1Dq_title",
			"separator": "lkl1Dq_separator",
			"dsh-skill-row-sweep": "lkl1Dq_dsh-skill-row-sweep",
			"summary": "lkl1Dq_summary",
			"row": "lkl1Dq_row",
			"instructions": "lkl1Dq_instructions",
			"leading": "lkl1Dq_leading",
			"errorSummary": "lkl1Dq_errorSummary",
			"visuallyHidden": "lkl1Dq_visuallyHidden",
			"chevron": "lkl1Dq_chevron",
			"iconIdle": "lkl1Dq_iconIdle"
		};
		//#endregion
