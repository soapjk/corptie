window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".qgsMXG_card{flex-direction:column;gap:8px;display:flex}.qgsMXG_row{align-items:center;min-height:32px;display:flex}.qgsMXG_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.qgsMXG_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.qgsMXG_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.qgsMXG_summary,.qgsMXG_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.qgsMXG_error{color:var(--dsw-alias-state-error-primary)}.qgsMXG_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.qgsMXG_card[data-cordis-status=awaiting-approval] .qgsMXG_status,.qgsMXG_card[data-cordis-status=client-pending] .qgsMXG_status{color:var(--dsw-alias-state-warn-label)}.qgsMXG_card[data-cordis-status=running] .qgsMXG_status{color:var(--dsw-alias-state-success-primary)}.qgsMXG_card[data-cordis-status=failed] .qgsMXG_status{color:var(--dsw-alias-state-error-primary)}.qgsMXG_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.qgsMXG_card:hover .qgsMXG_inspect,.qgsMXG_inspect:focus-visible{opacity:1}.qgsMXG_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.qgsMXG_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.qgsMXG_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.qgsMXG_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.qgsMXG_business .qgsMXG_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"row": "qgsMXG_row",
			"separator": "qgsMXG_separator",
			"error": "qgsMXG_error",
			"status": "qgsMXG_status",
			"inspect": "qgsMXG_inspect",
			"title": "qgsMXG_title",
			"message": "qgsMXG_message",
			"icon": "qgsMXG_icon",
			"business": "qgsMXG_business",
			"card": "qgsMXG_card",
			"summary": "qgsMXG_summary",
			"output": "qgsMXG_output"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".MNpsUa_card{flex-direction:column;display:flex}.MNpsUa_card .MNpsUa_title,.MNpsUa_card .MNpsUa_chevron{color:var(--dsw-alias-state-business-primary)}.MNpsUa_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.MNpsUa_row{gap:0}.MNpsUa_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.MNpsUa_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.MNpsUa_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.MNpsUa_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.MNpsUa_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.MNpsUa_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.MNpsUa_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.MNpsUa_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.MNpsUa_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.MNpsUa_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.MNpsUa_switch{height:22px;padding:0 8px;font-size:12px}.MNpsUa_card[data-terminal] .MNpsUa_title,.MNpsUa_card[data-terminal] .MNpsUa_name,.MNpsUa_card[data-terminal] .MNpsUa_purpose,.MNpsUa_card[data-terminal] .MNpsUa_statusLabel{color:var(--dsw-alias-label-caption)}.MNpsUa_card[data-terminal] .MNpsUa_separator{background:var(--dsw-alias-label-caption)}.MNpsUa_bodyWrap{flex-direction:column;display:flex}.MNpsUa_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.MNpsUa_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.MNpsUa_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.MNpsUa_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.MNpsUa_sourceTab:disabled{cursor:default;opacity:.4}.MNpsUa_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.MNpsUa_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.MNpsUa_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.MNpsUa_sourcePanel{max-height:260px;overflow:auto}.MNpsUa_sourceCode{margin:0}.MNpsUa_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.MNpsUa_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.MNpsUa_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.MNpsUa_output[data-error]{color:var(--dsw-alias-state-error-primary)}.MNpsUa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.MNpsUa_card:hover .MNpsUa_inspectButton,.MNpsUa_inspectButton:focus-visible{opacity:1}.MNpsUa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.MNpsUa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.MNpsUa_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"readout": "MNpsUa_readout",
			"card": "MNpsUa_card",
			"separator": "MNpsUa_separator",
			"sourceTab": "MNpsUa_sourceTab",
			"visuallyHidden": "MNpsUa_visuallyHidden",
			"name": "MNpsUa_name",
			"inspectButton": "MNpsUa_inspectButton",
			"row": "MNpsUa_row",
			"switch": "MNpsUa_switch",
			"notice": "MNpsUa_notice",
			"bodyWrap": "MNpsUa_bodyWrap",
			"panelHint": "MNpsUa_panelHint",
			"statusLabel": "MNpsUa_statusLabel",
			"chevron": "MNpsUa_chevron",
			"sourceTabActive": "MNpsUa_sourceTabActive",
			"sourceTabs": "MNpsUa_sourceTabs",
			"codeSection": "MNpsUa_codeSection",
			"purpose": "MNpsUa_purpose",
			"approvalPrompt": "MNpsUa_approvalPrompt",
			"sourceCard": "MNpsUa_sourceCard",
			"sourcePanel": "MNpsUa_sourcePanel",
			"sourceCode": "MNpsUa_sourceCode",
			"sectionLabel": "MNpsUa_sectionLabel",
			"output": "MNpsUa_output",
			"title": "MNpsUa_title",
			"requestError": "MNpsUa_requestError",
			"errorSummary": "MNpsUa_errorSummary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".DPhuoa_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.DPhuoa_footerButtons{align-items:center;width:100%;display:flex}.DPhuoa_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.DPhuoa_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.DPhuoa_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.DPhuoa_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.DPhuoa_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.DPhuoa_layer.DPhuoa_rail{width:36px;height:36px;margin:0}.DPhuoa_rail .DPhuoa_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.DPhuoa_rail .DPhuoa_footerButtons{flex-direction:column;gap:2px}.DPhuoa_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.DPhuoa_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.DPhuoa_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.DPhuoa_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.DPhuoa_note,.DPhuoa_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.DPhuoa_readError{color:var(--dsw-alias-state-error-primary)}.DPhuoa_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.DPhuoa_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.DPhuoa_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.DPhuoa_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.DPhuoa_rowHead{align-items:center;gap:8px;display:flex}.DPhuoa_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.DPhuoa_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.DPhuoa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.DPhuoa_row[data-cordis-status=idle] .DPhuoa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.DPhuoa_row[data-cordis-status=awaiting-approval] .DPhuoa_rowStatus,.DPhuoa_row[data-cordis-status=client-pending] .DPhuoa_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.DPhuoa_row[data-cordis-status=failed] .DPhuoa_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.DPhuoa_row[data-cordis-status=running] .DPhuoa_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.DPhuoa_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.DPhuoa_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.DPhuoa_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.DPhuoa_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.DPhuoa_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.DPhuoa_rowActions{flex:none;align-items:center;gap:10px;display:flex}.DPhuoa_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.DPhuoa_transitionActions{gap:6px;margin-left:auto;display:flex}.DPhuoa_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.DPhuoa_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.DPhuoa_transitionActions button:disabled{opacity:.4;cursor:default}.DPhuoa_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.DPhuoa_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.DPhuoa_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.DPhuoa_actionButton:disabled{opacity:.4;cursor:default}.DPhuoa_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.DPhuoa_doubleCheck svg{position:absolute;top:1px}.DPhuoa_doubleCheck svg:first-child{opacity:.7;left:0}.DPhuoa_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"badge": "DPhuoa_badge",
			"rowName": "DPhuoa_rowName",
			"group": "DPhuoa_group",
			"body": "DPhuoa_body",
			"rowError": "DPhuoa_rowError",
			"note": "DPhuoa_note",
			"transitionActions": "DPhuoa_transitionActions",
			"panel": "DPhuoa_panel",
			"rail": "DPhuoa_rail",
			"rows": "DPhuoa_rows",
			"actionButton": "DPhuoa_actionButton",
			"badgeCount": "DPhuoa_badgeCount",
			"versionPicker": "DPhuoa_versionPicker",
			"rowPurpose": "DPhuoa_rowPurpose",
			"rowDetail": "DPhuoa_rowDetail",
			"badgeLabel": "DPhuoa_badgeLabel",
			"footerButtons": "DPhuoa_footerButtons",
			"rowId": "DPhuoa_rowId",
			"doubleCheck": "DPhuoa_doubleCheck",
			"readError": "DPhuoa_readError",
			"activeVersion": "DPhuoa_activeVersion",
			"rowHead": "DPhuoa_rowHead",
			"header": "DPhuoa_header",
			"transition": "DPhuoa_transition",
			"row": "DPhuoa_row",
			"rowActions": "DPhuoa_rowActions",
			"layer": "DPhuoa_layer",
			"title": "DPhuoa_title",
			"rowStatus": "DPhuoa_rowStatus"
		};
		//#endregion
