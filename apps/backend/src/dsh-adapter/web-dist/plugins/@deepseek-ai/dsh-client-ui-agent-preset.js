window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".JEYbAa_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.JEYbAa_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".v3XA4G_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.v3XA4G_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.v3XA4G_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.v3XA4G_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.v3XA4G_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.v3XA4G_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.v3XA4G_selector:disabled{cursor:default}.v3XA4G_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"title": "v3XA4G_title",
			"desc": "v3XA4G_desc",
			"rowText": "v3XA4G_rowText",
			"row": "v3XA4G_row",
			"chevron": "v3XA4G_chevron",
			"selector": "v3XA4G_selector"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".KMktQW_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.KMktQW_seat:not(:disabled):hover,.KMktQW_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.KMktQW_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.KMktQW_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.KMktQW_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both KMktQW_seat-icon-in}@keyframes KMktQW_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.KMktQW_introText{white-space:pre;display:inline-block}.KMktQW_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards KMktQW_seat-char-in;display:inline-block}@keyframes KMktQW_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.KMktQW_introIcon,.KMktQW_introChar{opacity:1;animation:none}}.KMktQW_chevron{color:var(--dsw-alias-label-caption);flex:none}.KMktQW_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.KMktQW_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.KMktQW_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "KMktQW_chevron",
			"itemName": "KMktQW_itemName",
			"seat": "KMktQW_seat",
			"introText": "KMktQW_introText",
			"introChar": "KMktQW_introChar",
			"introIcon": "KMktQW_introIcon",
			"itemDesc": "KMktQW_itemDesc",
			"seatIcon": "KMktQW_seatIcon",
			"seat-icon-in": "KMktQW_seat-icon-in",
			"item": "KMktQW_item",
			"seat-char-in": "KMktQW_seat-char-in"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".HFdZLa_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.HFdZLa_title{margin:0;font-size:18px;font-weight:600}.HFdZLa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.HFdZLa_group{flex-direction:column;gap:10px;display:flex}.HFdZLa_group+.HFdZLa_group{margin-top:20px}.HFdZLa_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.HFdZLa_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.HFdZLa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.HFdZLa_card:hover:not(.HFdZLa_cardActive){border-color:var(--dsw-alias-label-dimmed)}.HFdZLa_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.HFdZLa_cardBroken,.HFdZLa_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.HFdZLa_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.HFdZLa_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.HFdZLa_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.HFdZLa_cardMain:disabled{cursor:default}.HFdZLa_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.HFdZLa_cardHead{align-items:center;gap:8px;display:flex}.HFdZLa_cardName{font-size:15px;font-weight:600;line-height:1.4}.HFdZLa_badge,.HFdZLa_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.HFdZLa_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.HFdZLa_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.HFdZLa_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.HFdZLa_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.HFdZLa_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.HFdZLa_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.HFdZLa_iconButton:disabled{opacity:.4;cursor:default}.HFdZLa_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.HFdZLa_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.HFdZLa_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.HFdZLa_iconButton:hover:after,.HFdZLa_iconButton:focus-visible:after{opacity:1}.HFdZLa_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.HFdZLa_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.HFdZLa_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.HFdZLa_revealedPathLabel{white-space:nowrap}.HFdZLa_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.HFdZLa_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.HFdZLa_secondaryButton:disabled{opacity:.5;cursor:default}.HFdZLa_field{flex-direction:column;gap:6px;display:flex}.HFdZLa_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.HFdZLa_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.HFdZLa_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.HFdZLa_input::placeholder{color:var(--dsw-alias-label-dimmed)}.HFdZLa_dialog{width:min(560px,100%)}.HFdZLa_dialogFields{flex-direction:column;gap:12px;display:flex}.HFdZLa_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.HFdZLa_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.HFdZLa_deleteDialog{width:min(480px,100%)}.HFdZLa_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.HFdZLa_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.HFdZLa_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.HFdZLa_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.HFdZLa_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"cardMain": "HFdZLa_cardMain",
			"card": "HFdZLa_card",
			"cardDesc": "HFdZLa_cardDesc",
			"revealedPath": "HFdZLa_revealedPath",
			"cardActive": "HFdZLa_cardActive",
			"inUse": "HFdZLa_inUse",
			"group": "HFdZLa_group",
			"cardBroken": "HFdZLa_cardBroken",
			"iconButton": "HFdZLa_iconButton",
			"creatorButton": "HFdZLa_creatorButton",
			"cardHead": "HFdZLa_cardHead",
			"badge": "HFdZLa_badge",
			"field": "HFdZLa_field",
			"cardBrokenReason": "HFdZLa_cardBrokenReason",
			"title": "HFdZLa_title",
			"secondaryButton": "HFdZLa_secondaryButton",
			"dialogFields": "HFdZLa_dialogFields",
			"cardId": "HFdZLa_cardId",
			"cardFoot": "HFdZLa_cardFoot",
			"deleteConfirm": "HFdZLa_deleteConfirm",
			"input": "HFdZLa_input",
			"cardName": "HFdZLa_cardName",
			"fieldLabel": "HFdZLa_fieldLabel",
			"section": "HFdZLa_section",
			"brokenBadge": "HFdZLa_brokenBadge",
			"error": "HFdZLa_error",
			"revealedPathLabel": "HFdZLa_revealedPathLabel",
			"groupHead": "HFdZLa_groupHead",
			"cards": "HFdZLa_cards",
			"intro": "HFdZLa_intro",
			"dialog": "HFdZLa_dialog",
			"iconDanger": "HFdZLa_iconDanger",
			"viewerCode": "HFdZLa_viewerCode",
			"deleteDialog": "HFdZLa_deleteDialog"
		};
		//#endregion
