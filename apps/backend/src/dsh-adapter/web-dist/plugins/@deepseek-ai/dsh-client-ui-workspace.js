window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".xlVdJa_projectRow,.xlVdJa_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.xlVdJa_projectRow:hover,.xlVdJa_sessionRow:hover,.xlVdJa_sessionRow.xlVdJa_selected{background:var(--dsw-alias-interactive-bg-hover)}.xlVdJa_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.xlVdJa_searchResultRow:hover,.xlVdJa_searchResultRow.xlVdJa_selected{background:var(--dsw-alias-interactive-bg-hover)}.xlVdJa_searchResultHeading{align-items:center;min-width:0;display:flex}.xlVdJa_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.xlVdJa_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.xlVdJa_searchResultWorkspace,.xlVdJa_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.xlVdJa_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.xlVdJa_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.xlVdJa_projectRow{box-sizing:border-box;align-items:center;height:34px}.xlVdJa_projectRow .xlVdJa_rowActions{height:20px}.xlVdJa_sessionRow{height:32px;animation:xlVdJa_row-in .15s var(--ds-ease-in-out);gap:0}.xlVdJa_sessionRow .xlVdJa_title{margin:0 6px 0 4px}.xlVdJa_flatSessionRowWithoutStatus .xlVdJa_title{margin-left:0}@keyframes xlVdJa_row-in{0%{opacity:0}}.xlVdJa_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.xlVdJa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.xlVdJa_folderActive{color:var(--dsw-alias-state-business-primary)}.xlVdJa_projectRow .xlVdJa_chevron{display:none}.xlVdJa_projectRow:hover .xlVdJa_chevron{display:inline-flex}.xlVdJa_projectRow:hover .xlVdJa_folder{display:none}.xlVdJa_arrow{transition:transform .15s var(--ds-ease-in-out)}.xlVdJa_arrowOpen{transform:rotate(90deg)}.xlVdJa_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.xlVdJa_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.xlVdJa_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.xlVdJa_sessionRow .xlVdJa_title{flex:1}.xlVdJa_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.xlVdJa_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.xlVdJa_dot{flex:none}.xlVdJa_rowActions{flex:none;align-items:center;gap:12px;display:none}.xlVdJa_projectRow:hover .xlVdJa_rowActions,.xlVdJa_sessionRow:hover .xlVdJa_rowActions,.xlVdJa_projectRow.xlVdJa_menuOpen .xlVdJa_rowActions,.xlVdJa_sessionRow.xlVdJa_menuOpen .xlVdJa_rowActions{display:inline-flex}.xlVdJa_sessionRow:hover .xlVdJa_time,.xlVdJa_sessionRow.xlVdJa_menuOpen .xlVdJa_time{display:none}.xlVdJa_projectRow.xlVdJa_menuOpen,.xlVdJa_sessionRow.xlVdJa_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.xlVdJa_sessionRow.xlVdJa_dropBefore,.xlVdJa_sessionRow.xlVdJa_dropAfter{position:relative}.xlVdJa_sessionRow.xlVdJa_dropBefore:before,.xlVdJa_sessionRow.xlVdJa_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.xlVdJa_sessionRow.xlVdJa_dropBefore:before{top:-7px}.xlVdJa_sessionRow.xlVdJa_dropAfter:after{bottom:-7px}.xlVdJa_hoverContent{flex-direction:column;gap:8px;display:flex}.xlVdJa_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.xlVdJa_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.xlVdJa_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.xlVdJa_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.xlVdJa_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.xlVdJa_iconButton:hover{color:var(--dsw-alias-label-primary)}.xlVdJa_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.xlVdJa_sessionRow,.xlVdJa_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"folder": "xlVdJa_folder",
			"title": "xlVdJa_title",
			"visuallyHidden": "xlVdJa_visuallyHidden",
			"searchResultTitle": "xlVdJa_searchResultTitle",
			"row-in": "xlVdJa_row-in",
			"searchResultRow": "xlVdJa_searchResultRow",
			"rowActions": "xlVdJa_rowActions",
			"meta": "xlVdJa_meta",
			"sessionRow": "xlVdJa_sessionRow",
			"searchResultMeta": "xlVdJa_searchResultMeta",
			"slot": "xlVdJa_slot",
			"arrow": "xlVdJa_arrow",
			"arrowOpen": "xlVdJa_arrowOpen",
			"projectText": "xlVdJa_projectText",
			"hoverContent": "xlVdJa_hoverContent",
			"flatSessionRowWithoutStatus": "xlVdJa_flatSessionRowWithoutStatus",
			"renameInput": "xlVdJa_renameInput",
			"hoverTime": "xlVdJa_hoverTime",
			"hoverStatus": "xlVdJa_hoverStatus",
			"searchResultSnippet": "xlVdJa_searchResultSnippet",
			"iconButton": "xlVdJa_iconButton",
			"selected": "xlVdJa_selected",
			"searchResultWorkspace": "xlVdJa_searchResultWorkspace",
			"dropBefore": "xlVdJa_dropBefore",
			"chevron": "xlVdJa_chevron",
			"menuOpen": "xlVdJa_menuOpen",
			"dropAfter": "xlVdJa_dropAfter",
			"hoverTitle": "xlVdJa_hoverTitle",
			"searchResultHeading": "xlVdJa_searchResultHeading",
			"folderActive": "xlVdJa_folderActive",
			"dot": "xlVdJa_dot",
			"time": "xlVdJa_time",
			"projectRow": "xlVdJa_projectRow",
			"hoverPath": "xlVdJa_hoverPath"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".pPzFQa_modalAction{min-width:72px}.pPzFQa_modalError,.pPzFQa_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.pPzFQa_modalError{color:var(--dsw-alias-state-error-primary)}.pPzFQa_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"modalAction": "pPzFQa_modalAction",
			"menuStatus": "pPzFQa_menuStatus",
			"modalError": "pPzFQa_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Volumes/T9/deepseek-harness/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".Zmv-RG_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.Zmv-RG_root.Zmv-RG_rail{padding-right:0}.Zmv-RG_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.Zmv-RG_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Zmv-RG_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.Zmv-RG_root:not(.Zmv-RG_rail) .Zmv-RG_sectionHeader{margin-top:2px;margin-right:-4px}.Zmv-RG_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.Zmv-RG_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.Zmv-RG_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.Zmv-RG_searchSlotExpanded{max-width:100%;padding-left:0}.Zmv-RG_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.Zmv-RG_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.Zmv-RG_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.Zmv-RG_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.Zmv-RG_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.Zmv-RG_searchExpanded .Zmv-RG_searchButton{width:28px;height:30px}.Zmv-RG_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Zmv-RG_searchExpanded .Zmv-RG_searchButton:hover{background:0 0}.Zmv-RG_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.Zmv-RG_searchExpanded .Zmv-RG_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.Zmv-RG_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.Zmv-RG_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.Zmv-RG_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Zmv-RG_rail .Zmv-RG_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.Zmv-RG_rail .Zmv-RG_headerActions{max-width:none}.Zmv-RG_rail .Zmv-RG_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.Zmv-RG_rail .Zmv-RG_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.Zmv-RG_rail .Zmv-RG_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.Zmv-RG_rail .Zmv-RG_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Zmv-RG_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.Zmv-RG_rail .Zmv-RG_listArea{margin-left:0;margin-right:0;padding-left:0}.Zmv-RG_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.Zmv-RG_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.Zmv-RG_wide{animation:Zmv-RG_wide-in .2s var(--ds-ease-in-out)}@keyframes Zmv-RG_wide-in{0%{opacity:0}}.Zmv-RG_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.Zmv-RG_flatList>*+*,.Zmv-RG_searchTree>[role=treeitem]+[role=treeitem],.Zmv-RG_groupSection>*+*{margin-top:2px}.Zmv-RG_searchStatus,.Zmv-RG_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.Zmv-RG_searchWarning{color:var(--dsw-alias-label-secondary)}.Zmv-RG_groupSection{position:relative}.Zmv-RG_groupSection+.Zmv-RG_groupSection{margin-top:4px}.Zmv-RG_listTopDropIndicator,.Zmv-RG_workspaceDropBefore:before,.Zmv-RG_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.Zmv-RG_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.Zmv-RG_listTopDropActive>.Zmv-RG_workspaceDropBefore:first-child:before{display:none}.Zmv-RG_workspaceDropBefore:before{top:-8px}.Zmv-RG_workspaceDropAfter:after{bottom:-8px}.Zmv-RG_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.Zmv-RG_groupSection>.Zmv-RG_sessionOverflowButton{margin-top:0}.Zmv-RG_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.Zmv-RG_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.Zmv-RG_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.Zmv-RG_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.Zmv-RG_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.Zmv-RG_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.Zmv-RG_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.Zmv-RG_wide{animation:none}.Zmv-RG_search,.Zmv-RG_sectionLabel,.Zmv-RG_searchSlot,.Zmv-RG_searchInput,.Zmv-RG_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"wide-in": "Zmv-RG_wide-in",
			"sectionHeader": "Zmv-RG_sectionHeader",
			"deleteStatus": "Zmv-RG_deleteStatus",
			"iconButton": "Zmv-RG_iconButton",
			"headerActions": "Zmv-RG_headerActions",
			"treeBody": "Zmv-RG_treeBody",
			"fade": "Zmv-RG_fade",
			"searchTree": "Zmv-RG_searchTree",
			"groupSection": "Zmv-RG_groupSection",
			"sectionLabel": "Zmv-RG_sectionLabel",
			"deleteAction": "Zmv-RG_deleteAction",
			"sessionOverflowButton": "Zmv-RG_sessionOverflowButton",
			"searchExpanded": "Zmv-RG_searchExpanded",
			"rail": "Zmv-RG_rail",
			"searchWarning": "Zmv-RG_searchWarning",
			"renameError": "Zmv-RG_renameError",
			"sectionLabelHidden": "Zmv-RG_sectionLabelHidden",
			"listArea": "Zmv-RG_listArea",
			"clearButton": "Zmv-RG_clearButton",
			"list": "Zmv-RG_list",
			"searchSlot": "Zmv-RG_searchSlot",
			"headerActionsHidden": "Zmv-RG_headerActionsHidden",
			"renameInput": "Zmv-RG_renameInput",
			"workspaceDropAfter": "Zmv-RG_workspaceDropAfter",
			"wide": "Zmv-RG_wide",
			"searchButton": "Zmv-RG_searchButton",
			"flatList": "Zmv-RG_flatList",
			"searchInput": "Zmv-RG_searchInput",
			"listTopDropIndicator": "Zmv-RG_listTopDropIndicator",
			"listTopDropActive": "Zmv-RG_listTopDropActive",
			"empty": "Zmv-RG_empty",
			"searchSlotExpanded": "Zmv-RG_searchSlotExpanded",
			"workspaceDropBefore": "Zmv-RG_workspaceDropBefore",
			"search": "Zmv-RG_search",
			"searchStatus": "Zmv-RG_searchStatus",
			"root": "Zmv-RG_root"
		};
		//#endregion
