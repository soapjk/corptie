export const AGENT_PROVIDER_CAPABILITIES = Object.freeze({
  ...
  CONVERSATION_COMMAND: "conversation.command",
  CONVERSATION_SEND_IMAGE: "conversation.send.image",
...
export const AGENT_PROVIDER_METHOD_BY_CAPABILITY = Object.freeze({
  ...
  [AGENT_PROVIDER_CAPABILITIES.CONVERSATION_COMMAND]: "executeCommand",
  [AGENT_PROVIDER_CAPABILITIES.CONVERSATION_SEND_IMAGE]: "send",
